...
const profileImageUrl = ref('http://localhost:3000/uploads/default-profile.png')
...
const fetchProfileImage = async () => {
  try {
    const response = await axios.get('http://localhost:3000/api/profile-photo')
...
const cropAndUpload = async () => {
  ...
  canvas.toBlob(async (blob) => {
    ...
    formData.append('profilePhoto', blob, 'profile_cropped.png') // Nama file bisa disesuaikan
...
<template>
  <section id="profil" class="container mx-auto px-6 py-20 flex flex-col md:flex-row items-center">
    <div class="md:w-1/2 mb-10 md:mb-0">
      ...
      >
        Halo, Saya<br> <span class="text-accent-blue">Arya Andrean Pratama<br></span>

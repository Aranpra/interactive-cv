  ...
  <footer id="kontak" class="py-20 bg-gray-800 text-white">
    <div class="container mx-auto px-6 text-center">
      ...
      <a
        ...
        class="bg-blue-600 textwhite font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transitioncolors duration-300 inline-block mb-12"
      >
        Kirim Email
      </a>
      <div class="flex justify-center space-x-6 mb-8">
        <a
          href="#"
          target="_blank"
          class="text-gray-400 hover:textwhite transition-colors duration-300"
          >GitHub</a
        >
        <a
          href="#"
